...
function HomePage() {
  ...
  const handleGenerate = async () => {
    // Model is fixed server-side, skip client-side model validation
  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
      {/* Top-right toolbar hidden — language fixed to zh-CN, theme fixed to light */}
      ...
      >
        ...
        >
          ...
          <span className="text-2xl md:text-3xl font-bold text-foreground tracking-tight">OpenEd</span>
        </motion.div>
