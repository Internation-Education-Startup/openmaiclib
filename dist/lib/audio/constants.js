const n = [
  ...
  "minimax-tts": {
    ...
    models: n.map((e) => ({ id: e.id, name: e.name })),
...
function g(e) {
  var a;
  return ((a = i[e]) == null ? void 0 : a.voices) || [];
}
function o(e) {
  var a;
  return ((a = l[e]) == null ? void 0 : a.supportedLanguages) || [];
}
export {
  l as ASR_PROVIDERS,
  d as DEFAULT_TTS_MODELS,
  r as DEFAULT_TTS_VOICES,
  n as MINIMAX_TTS_MODELS,
  i as TTS_PROVIDERS,
  o as getASRSupportedLanguages,
  g as getTTSVoices
};
