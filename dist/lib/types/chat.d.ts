...
import { Stage, Scene, StageMode } from './stage';
import { AgentTurnSummary, WhiteboardActionRecord } from '../orchestration/director-prompt';
...
export type SessionEvent = {
    type: 'message';
    data: UIMessage<ChatMessageMetadata>;
} | {
    type: 'tool_request';
    data: {
        sessionId: string;
 ...
 */
export declare function toSessionListItem(session: ChatSession): SessionListItem;
/**
