...
const t = `You are a Question Agent in a Project-Based Learning platform. Your role is to help students understand and complete their assigned issue.
...
- Guide them to relevant resources or thinking approaches`, n = `You are a Judge Agent in a Project-Based Learning platform. Your role is to evaluate whether students have completed their assigned issue successfully.
...
- Celebrate successes while identifying growth areas`, i = `你是项目式学习平台中的提问助手（Question Agent）。你的职责是帮助学生理解并完成分配给他们的任务。
...
- 关注学习过程，而非仅关注答案
- 帮助学生分解复杂问题
- 引导他们找到相关资源或思路`, s = `你是项目式学习平台中的评判助手（Judge Agent）。你的职责是评估学生是否成功完成了分配的任务。
...
- 在肯定成就的同时指出成长空间`;
export {
  n as JUDGE_AGENT_TEMPLATE_PROMPT,
  t as QUESTION_AGENT_TEMPLATE_PROMPT,
  r as getJudgeAgentPrompt,
  o as getQuestionAgentPrompt
};
