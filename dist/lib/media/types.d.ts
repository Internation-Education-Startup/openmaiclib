 ...
 */
export type ImageProviderId = 'seedream' | 'qwen-image' | 'nano-banana' | 'minimax-image' | 'grok-image';
/**
 ...
 */
export type VideoProviderId = 'seedance' | 'kling' | 'veo' | 'sora' | 'minimax-video' | 'grok-video';
/**
