...
export declare function createStageAPI(store: StageStore): {
    scene: {
        ...
        update(sceneId: string, updates: Partial<import('../..').Scene>): import('./stage-api-types').APIResult<boolean>;
        list(): import('./stage-api-types').APIResult<import('../..').Scene[]>;
        get(sceneId: string): import('./stage-api-types').APIResult<import('../..').Scene>;
    };
    navigation: {
        ...
        current(): import('./stage-api-types').APIResult<import('../..').Scene>;
    };
    element: {
    ...
    stage: {
        get(): import('./stage-api-types').APIResult<import('../..').StageType>;
        update(updates: Partial<import('../..').StageType>): import('./stage-api-types').APIResult<boolean>;
    };
};
export type StageAPI = ReturnType<typeof createStageAPI>;
//# sourceMappingURL=stage-api.d.ts.map