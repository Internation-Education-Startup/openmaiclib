...
export function Stage({
  ...
  // Scene viewer height: use flex-1 to fill remaining space instead of calc()
  // (calc(100% - Npx) breaks when ancestor height is flex-determined, not explicit)
  const sceneViewerHeight: string | undefined = undefined;
