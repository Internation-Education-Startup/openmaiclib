...
import { ImageClipDataRange, PPTElementOutline, PPTElementShadow, Gradient } from './slides';
...
export declare enum ElementAlignCommands {
    TOP = "top",
    BOTTOM = "bottom",
    LEFT = "left",
    RIGHT = "right",
...
export declare const enum OperateBorderLines {
    T = "top",
    B = "bottom",
    L = "left",
    R = "right"
}
export declare const enum OperateResizeHandlers {
    LEFT_TOP = "left-top",
    TOP = "top",
    RIGHT_TOP = "right-top",
    LEFT = "left",
...
export declare const enum OperateLineHandlers {
    START = "start",
    END = "end",
    C = "ctrl",
    C1 = "ctrl1",
