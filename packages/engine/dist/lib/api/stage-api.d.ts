...
export declare function createStageAPI(store: StageStore): {
    scene: {
        ...
        update(sceneId: string, updates: Partial<import('../../packages/engine').Scene>): import('./stage-api-types').APIResult<boolean>;
        list(): import('./stage-api-types').APIResult<import('../../packages/engine').Scene[]>;
        get(sceneId: string): import('./stage-api-types').APIResult<import('../../packages/engine').Scene>;
    };
    navigation: {
        ...
        current(): import('./stage-api-types').APIResult<import('../../packages/engine').Scene>;
    };
    element: {
    ...
    stage: {
        get(): import('./stage-api-types').APIResult<import('../../packages/engine').StageType>;
        update(updates: Partial<import('../../packages/engine').StageType>): import('./stage-api-types').APIResult<boolean>;
    };
};
